...
Before continuing through the exercise, you may want to refresh your knowledge on the weekend's lesson about [Parsing JSON](/intermediate-javascript/asynchrony-and-apis/parsing-json).
...
* Create a new project directory named `JSON Practice`
  ...
  * Read through [this previous lesson on JavaScript Objects](/intermediate-javascript/object-oriented-javascript/javascript-objects) and note with your pair the major differences and similarities between JSON objects and JavaScript Objects.
