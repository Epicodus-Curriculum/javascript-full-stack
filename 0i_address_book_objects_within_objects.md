...
As we discussed in [Variable Scope](/introduction-to-programming/javascript-and-web-browsers/homework-variable-scope), we want to avoid global variables wherever possible. So why are we going to use one here?
