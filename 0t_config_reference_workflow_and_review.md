...
When installing packages, we often include a version number. npm packages use **semantic versioning**. Review the lesson on [semantic versioning](/intermediate-javascript/test-driven-development-and-environments-with-javascript/semantic-versioning) if you need a refresher.
