...
If you did not read the lesson [Optional: Accessing Stylesheets in the CSSOM](/intermediate-javascript/object-oriented-javascript-part-2/optional-accessing-stylesheets-in-the-cssom), don't worry. We don't need to know how the CSSOM works (or about its object types) in order to understand the implication of live data. So, let's continue. 
